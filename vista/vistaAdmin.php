...
<a name="Inicio"></a>
	...
	<li><a href="../cierresesion.php">Cerrar sesión<span class="icon-dot"></span></a></li>
        ...
        <table class="table caption-top">
            <caption>Listado Veterinarios</caption>
            <tr>
                <th>id</th><th>Nombre completo</th><th>Rol</th><th>Modificar</th><th>Eliminar</th>
            </tr>
<?php
    ...
    $enlace ="<a href='../controlador/ctrlVeterinario.php?accion=modificar&id=";
    $enlace2 ="<a href='../controlador/ctrlVeterinario.php?accion=eliminar&id=";
    foreach($clientes as $cliente){
        echo "<tr><td>". $cliente['codigoUsu'] ."</td><td>". $cliente['apellido'] ." ". $cliente['nombre'] ."</td><td>". $cliente['rol'] ."</td><td>".$enlace . $cliente['codigoUsu'] ."'><i class='fas fa-edit'></i></a></td><td>".$enlace2 . $cliente['codigoUsu'] ."'><i class='fas fa-trash-alt'></i></a></td></tr>";
    }
?>
    </table>
    </div>
...
<?php
    ...
    foreach($clientes as $cliente){
        echo "<tr><td>". $cliente['idCliente'] ."</td><td>". $cliente['apellido'] ." ". $cliente['nombre'] ."</td><td>". $cliente['rol'] ."</td><td>".$enlace . $cliente['idCliente'] ."'><i class='fas fa-edit'></i></a></td><td>".$enlace2 . $cliente['idCliente'] ."'><i class='fas fa-trash-alt'></i></a></td></tr>";
    }
?>
    </table>
    </div>
