...
<head>
    ...
    <script src="validarPass.js"></script>
    <title>Cliente</title>
</head>
<body>
<header>
    ...
    <div class="container">    
        <form action="../controlador/ctrlCliente.php" method="post" onsubmit="return validarPass()">
        ...
        <div class="col">
            ...
            <input type="radio" name="roles" value="Rescatista"required>Rescatista
                <input type="radio" name="roles" value="Usuario Normal"required>Usuario Normal
        </div>
        </div>
        <div class="form-group  mb-2 row">
        <div class="col">
        ...
        <div class="col">
            ...
            <datalist id="pregS">
            <option value="¿Como se llama la calle donde creciste?">
            <option value="¿Como se llama tu país favorito?">
            <option value="¿Como se conocieron tus padres?">
            <option value="¿Cual era tu apodo de la infancia?">
            <option value="¿A que país te gustaria viajar?">
            </datalist>
        </div>
        <div class="col">
        ...
        <div class="col">
            ...
            <input id="password" type="password" name="pass" class="form-control" placeholder="La contraseña tiene q contener un numero y mas de 4 caracteres y tiene q ser mayor a 8 y menor a 10" required><br>
        </div>
