...
<?php
	...
	$query = "SELECT * FROM  forov WHERE ID = '$id' ORDER BY fecha DESC";
	...
	while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
		...
		echo "<a class='link' href='../formularioRespuVet.php?id&respuestas=$respuestas&identificador=$id&id3=$id2'>Consultar</a><br><br>";
		echo "</div>";
	}	
	$query2 = "SELECT * FROM  forov WHERE identificador = '$id' ORDER BY fecha DESC";
	$result2 = $mysqli->query($query2);
	echo "<br><hr><br><br><p class='p1'>Lista de consultas</p><br><br>";
	...
	while($row = mysqli_fetch_array($result2, MYSQLI_ASSOC)){
        ...
        $cadena=$id4;
    	$cadena= substr($cadena, -1);
        $enlace2 ="<a href='../controlador/ctrlCliente.php?accion=eliminar4&id=";
		echo"<div class='margen'>";
		echo "<div class='container'>";
		echo "<table class='tabla1'>";
		echo "<tr><td class='dos'>Usuario: $autor</td><td class='uno'>Consulta: $mensaje</td>";
        if($cadena==2){ 
		...
		echo "<a class='link' href='../formularioRespuVet.php?id&respuestas=$respuestas&identificador=$id'>Responder</a><br><br>";
		echo "</div>";
		echo"</div>";
        }elseif($cadena==0)
        echo"</div><br>";
