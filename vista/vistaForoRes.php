...
<?php
	...
	$query = "SELECT * FROM  foror WHERE ID = '$id' ORDER BY fecha DESC";
	...
	while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
		...
		echo "<a class='link' href='../formularioRespuRes.php?id&respuestas=$respuestas&identificador=$id&id3=$id2'>Me apunto</a><br><br>";
		echo "</div>";

	}	
	$query2 = "SELECT * FROM  foror WHERE identificador = '$id' ORDER BY fecha DESC";
	$result2 = $mysqli->query($query2);
	echo "<br><hr><br><br><p class='p1'>Lista de usuarios anotados</p><br><br>";
	...
	while($row = mysqli_fetch_array($result2, MYSQLI_ASSOC)){
		...
		echo "<table class='tabla1'>";
		echo "<tr><td class='dos'>Usuario: $autor</td><td class='uno'>Motivo: $mensaje</td>";
        if($cadena==2){ 
