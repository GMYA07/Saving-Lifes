					...
					while ($perFila=$tarjetas->fetch(PDO::FETCH_ASSOC))
					{
                        ...
                        <div class='flip-card-inner'> 
                            <div class='flip-card-front'>
                                <img class='targetIMG' src='data:image/png;base64,".base64_encode($perFila['Foto'])." '  > 
                            </div>
                            <div class='flip-card-back'>
                                ...
                                <p>
                                    <b>Especie:".$perFila['especie']."</b>
                                </p>
                                <p>
                                    <b>Raza:". $perFila['raza']. "</b>
                                </p>
                                <p>
                                    <b>Edad:". $perFila['Edad']. "</b>
                                </p>
                                <p>
                                    <b>Sexo:". $perFila['Sexo']. "</b>
                                </p>
                                <p>
                                    <b>Peso:". $perFila['Peso']. "</b>
                                </p>
                                <p>
                                    <b>Control de vacunas:". $perFila['Control']. "</b>
                                </p>
                                <p>
                                    <b>Proveniencia:". $perFila['Proveniencia']. "</b>
                                </p><br> 
                                <button class='button' ><a href='Formulario-Adopcion.php'><b>Adoptar</b></a></button>  
                            </div> 
                        </div> 
                    </div>";
					}
