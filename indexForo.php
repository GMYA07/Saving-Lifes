...
<?php 
	...
	if($cadena==2){
		...
		<td class='dos' width='200px'><b>Eliminar foro</b></td>
		</tr>";
	while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
		...
		echo "<tr>";
			echo "<td class='dos'><a class='ver' href='vista/vistaForo.php?id=$id&id2=$id3'><b>ver</b></a></td>";
			echo "<td class='uno'>$titulo</td>";
			echo "<td class='uno'>".date($fecha)."</td>";
...
<form class="form" action="formularioNForo.php">
