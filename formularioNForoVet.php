...
include("modelo/conexForo.php");
 $id3= $_SESSION['id'];
 echo "<form name='form' action='modelo/daoForoVet.php?id=$id3' method='post'>";
 if($cadena==1){
...
?>
<form name="form" action="modelo/daoForoVet.php" method="post">
	...
	<input type="hidden" name="respuestas" value="<?php echo $respuestas;?>">
      ...
      <textarea name="mensaje" cols="50" rows="5" required="required"></textarea>
